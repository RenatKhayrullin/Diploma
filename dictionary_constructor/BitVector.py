...
__doc__ = '''
    ...
    HOW THE BIT VECTORS ARE STORED:
        ...
        The first keyword option processed_text by `__init__()' is for
        ...
        The next option processed_text by `__init_()' is for the `size' keyword
        ...
        The next constructor keyword processed_text by `__init__()' is
